...
jQuery( function( $ ) { 
    ...
    if ( ultra_smooth_scroll_params.value ) {
        ...
        jQuery( document ).ready( function() {
            jQuery( '#site-navigation a[href*="#"]:not([href="#"]), .comments-link a[href*="#"]:not([href="#"]), .puro-scroll[href*="#"]:not([href="#"])' ).bind( 'click', function() {
    ...
    function ultraScrolled() {  
        ...
        jQuery( '.panel-grid .panel-row-style' ).each( function() {
